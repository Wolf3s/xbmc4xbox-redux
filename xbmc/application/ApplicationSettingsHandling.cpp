...
void CApplicationSettingsHandling::RegisterSettings()
{
  ...
  temp.insert(CSettings::SETTING_HARDDISK_AAMLEVEL);
  temp.insert(CSettings::SETTING_HARDDISK_APMLEVEL);
  temp.insert(CSettings::SETTING_LCD_BACKLIGHT);
  temp.insert(CSettings::SETTING_LCD_CONTRAST);
  temp.insert(CSettings::SETTING_LCD_MODCHIP);
  temp.insert(CSettings::SETTING_LCD_TYPE);
  temp.insert(CSettings::SETTING_TRAINER_SCAN);
  temp.insert(CSettings::SETTING_NETWORK_ASSIGNMENT);
  temp.insert(CSettings::SETTING_NETWORK_IPADDRESS);
  temp.insert(CSettings::SETTING_NETWORK_SUBNET);
  temp.insert(CSettings::SETTING_NETWORK_GATEWAY);
  temp.insert(CSettings::SETTING_NETWORK_DNS);
  temp.insert(CSettings::SETTING_NETWORK_DNS2);
  temp.insert(CSettings::SETTING_UPDATER_CHECK);
  temp.insert(CSettings::SETTING_XBOX_LED_COLOUR);
