...
namespace FONT
{
static const char* SUPPORTED_EXTENSIONS_MASK = ".ttf|.ttc|.otf";

// The default application font
static const char* FONT_DEFAULT_FILENAME = "arial.ttf";

namespace FONTPATH
{
// Directory where Kodi bundled fonts files are located
static const char* SYSTEM = "special://xbmc/media/Fonts/";
// Directory where user defined fonts are located
static const char* USER = "special://home/media/Fonts/";
// Temporary font path (where MKV fonts are extracted and temporarily stored)
static const char* TEMP = "special://temp/fonts/";
